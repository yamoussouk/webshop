...
public class Bootstrap implements CommandLineRunner {
    ...
    public Bootstrap(ProductRepository productRepository, UserRepository userRepository, AuthorityRepository authorityRepository,
                     ImageRepository imageRepository, RoleRepository roleRepository, OrdersRepository ordersRepository,
                     ProductToProductCommand productConverter, UserToUserCommand userConverter) {
